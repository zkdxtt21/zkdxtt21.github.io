...
- Graph Attentional Layer
    - perform self-attention on nodes - a shared attentional mechanism a, which computes attention coefficients:  
        ![eq1](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq1.png)
    - normalize the coefficients using the softmax function to makethem easily comparable across different nodes:  
        ![eq2](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq2.png)
    - In their experiments, the structure they use:  
        ![eq3](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq3.png)  
    ...
    - Once obtained, compute a linear combination using these normalized attention coefficients to sever as the final output features for every node (after potentially applying a nonlinearity, $\sigma$):  
        ![eq4](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq4.png)
    - multi-head attention:  
        ![eq5](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq5.png)  
    ...
    - Specially, we employ averaging, and delay applying the final nonlineariry:  
        ![eq6](https://github.com/zkdxtt21/zkdxtt21.github.io/blob/master/_posts/images/GAT-eq6.png)
